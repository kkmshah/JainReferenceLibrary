...
public interface ApiInterface {
    ...
    */
    ...
    public Call<AddAllMyShelfResModel> addAllMyShelf(@Field("user_id") String userId, @Field("hold_id") String holdId, @Field("previous") String previous, @Field("next") String next);

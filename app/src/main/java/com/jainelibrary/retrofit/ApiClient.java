...
public class ApiClient {
    ...
    public static void addAllMyShelf(String strUid, String strBookId, Callback<AddAllMyShelfResModel> listener) {
        getApiClient().addAllMyShelf(strUid, strBookId).enqueue(listener);
    }

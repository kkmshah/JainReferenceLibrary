...
public class RelationRefBookListAdapter extends RecyclerView.Adapter<RelationRefBookListAdapter.ViewHolder> {
    private static final String TAG = RelationRefBookListAdapter.class.getSimpleName();
    ...
    ArrayList<RelationModel.ReferenceBook> bookList = new ArrayList<>();

    BookClickListener listener;
    ArrayList<RelationModel.ReferenceBook.ReferencePage> bookPageModels = new ArrayList<>();
    public static int BARRAY = 100;



    public RelationRefBookListAdapter(Context context, ArrayList<RelationModel.ReferenceBook> bookList, BookClickListener listener) {
    ...
    @NonNull
    @Override
    public RelationRefBookListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_relation_book_list, parent, false);
        return new  RelationRefBookListAdapter.ViewHolder(v);
    }
